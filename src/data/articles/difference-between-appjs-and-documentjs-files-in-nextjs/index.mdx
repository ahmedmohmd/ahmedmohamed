...
Next.js is a Framework which build above React.js, Next.js Team called it The React Framework for Production, Which let you optimize your React Applications throw <A href="https://nextjs.org/docs/basic-features/pages#static-generation-recommended">SSG</A>, <A href="https://nextjs.org/docs/basic-features/data-fetching/incremental-static-regeneration">ISR</A> and <A href="https://nextjs.org/docs/basic-features/pages#server-side-rendering">SSR</A> Strategies.
